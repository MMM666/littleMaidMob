            	...
            	if (detonator && isItemExplord(i)) { 
            		...
            		for (int l = 0; l < it.stackSize; l++) {
            			...
            			((BlockTNT)Block.blocksList[j]).onBlockDestroyedByExplosion(entityLittleMaid.worldObj,
            					...
            					MathHelper.floor_double(entityLittleMaid.posZ) + entityLittleMaid.rand.nextInt(7) - 3);
            		}
            	} else {
...
//            if (mainInventory[j] != null && mainInventory[j].getItem().getClass().isAssignableFrom(itemClass)) {
    ...
    public static boolean isItemSmelting(ItemStack pItemstack) {
    	return (pItemstack != null && FurnaceRecipes.smelting().getSmeltingResult(pItemstack.itemID) != null);
    }
    ...
    public static boolean isItemExplord(ItemStack pItemstack) {
		...
		return (pItemstack != null && li instanceof ItemBlock && Block.blocksList[li.itemID].blockMaterial == Material.tnt);
    }
