...
//        drawString(fontRenderer, LMM_GuiIFF.IFFString[tt], pX + 78 + width / 2, pY + 18, c);
//        drawString(fontRenderer, pName, pX + 70, pY + 6, 0xffffff);
        drawString(fontRenderer, LMM_GuiIFF.IFFString[tt], (width - fontRenderer.getStringWidth(LMM_GuiIFF.IFFString[tt])) / 2, pY + 18, c);
        drawString(fontRenderer, pName, (width - fontRenderer.getStringWidth(pName)) / 2, pY + 6, 0xffffff);
	}
