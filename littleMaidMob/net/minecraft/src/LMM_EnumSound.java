...
public enum LMM_EnumSound {
    ...
    living_morning(0x500, "Living Voice in Mornig. Null is no Voice", "mob.ghast.moan"),
    living_daytime(0x501, "Living Voice(Default) in Daytime. Null is no Voice", "^"),
    ...
    goodmorning(0x550, "Goodmorning Voice. Null is no Voice", "mob.wolf.bark"),
    goodnight(0x551, "Goodnight Voice. Null is no Voice", "mob.ghast.affectionate scream"),
